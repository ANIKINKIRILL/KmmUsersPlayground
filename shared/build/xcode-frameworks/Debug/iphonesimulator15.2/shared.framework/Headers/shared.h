...
@interface SharedUserMapper : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSArray<SharedUser *> *)mapUsers:(NSArray<SharedUserDto *> *)users __attribute__((swift_name("map(users:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserDto")))
@interface SharedUserDto : SharedBase
- (instancetype)initWithId:(SharedInt * _Nullable)id name:(NSString * _Nullable)name username:(NSString * _Nullable)username __attribute__((swift_name("init(id:name:username:)"))) __attribute__((objc_designated_initializer));
...
- (SharedUserDto *)doCopyId:(SharedInt * _Nullable)id name:(NSString * _Nullable)name username:(NSString * _Nullable)username __attribute__((swift_name("doCopy(id:name:username:)")));
...
@interface SharedUserRepositoryImpl : SharedBase <SharedUserRepository>
- (instancetype)initWithRemote:(id<SharedUserService>)remote mapper:(SharedUserMapper *)mapper __attribute__((swift_name("init(remote:mapper:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getUsersWithCompletionHandler:(void (^)(NSArray<SharedUserDto *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getUsers(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserServiceImpl")))
@interface SharedUserServiceImpl : SharedBase <SharedUserService>
...
@interface SharedGetUsersUseCase : SharedBase
- (instancetype)initWithUserRepository:(id<SharedUserRepository>)userRepository __attribute__((swift_name("init(userRepository:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)executeWithCompletionHandler:(void (^)(NSArray<SharedUser *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("execute(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("User")))
@interface SharedUser : SharedBase
- (instancetype)initWithId:(int32_t)id name:(NSString *)name username:(NSString *)username __attribute__((swift_name("init(id:name:username:)"))) __attribute__((objc_designated_initializer));
...
- (SharedUser *)doCopyId:(int32_t)id name:(NSString *)name username:(NSString *)username __attribute__((swift_name("doCopy(id:name:username:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedIosHttpClientKt : SharedBase
+ (SharedKtor_client_coreHttpClient *)iosHttpClient __attribute__((swift_name("iosHttpClient()")));
@end
